          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              ...
              >
                ...
                Thingz: Your Digital Universe, Organized.like never before
                </h1>
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                Thingz revolutionizes how you manage digital snippets—passwords, notes, URLs, and more. With AI-powered organization, everything you need is just a tap away.
                </p>
                ...
                <div>
                  <p className="mb-4 text-center text-base font-medium text-white/60">
                    Thingz is now available for all popular platforms
                  </p>
                  <div
